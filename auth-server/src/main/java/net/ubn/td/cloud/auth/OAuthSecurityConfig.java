...
public class OAuthSecurityConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		endpoints.tokenStore(tokeStore()).authenticationManager(authenticationManager);
	...
	// Configure the ClientDetailsService, e.g. declaring individual clients and
	// their properties.
	@Override
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		clients.inMemory().withClient("clientId").secret("secretId").authorizedGrantTypes("authorization_code",
				"client_credentials", "refresh_token", "password", "implicit").scopes("read");
	}
}
