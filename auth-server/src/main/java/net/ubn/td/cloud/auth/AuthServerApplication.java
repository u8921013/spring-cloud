...
public class AuthServerApplication {
	...
	public AccountDTO getUserInfo(Principal user) {
		System.out.println(user.getName());
		
		return userInfos().get(user.getName());
//		return user;
	}
	...
	public List<BookInfo> getUserInfo(@PathVariable(value="classname") String classname) {
		...
		bookInfo1.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK08");
		reusltList.add(bookInfo1);
		
		BookInfo bookInfo2=new BookInfo();
		bookInfo2.setId("BOK09");
		bookInfo2.setName("Ch6-認識參考型別與操作物件");
		bookInfo2.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK09&bookNo=BOK09");
		reusltList.add(bookInfo2);
		
		BookInfo bookInfo3=new BookInfo();
		bookInfo3.setId("BOK10");
		bookInfo3.setName("Ch6-測驗一");
		bookInfo3.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK10");
		reusltList.add(bookInfo3);
		
		BookInfo bookInfo4=new BookInfo();
		bookInfo4.setId("BOK11");
		bookInfo4.setName("Ch6-測驗二");
		bookInfo4.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK11");
		...
		bookInfo5.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK12");
		reusltList.add(bookInfo5);
		
		BookInfo bookInfo6=new BookInfo();
		bookInfo6.setId("BOK13");
		bookInfo6.setName("Ch10-測驗一");
		bookInfo6.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK13");
		reusltList.add(bookInfo6);
		
		BookInfo bookInfo7=new BookInfo();
		bookInfo7.setId("BOK14");
		bookInfo7.setName("Ch10-測驗二<");
		bookInfo7.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK14");
		...
		bookInfo8.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK15");
		reusltList.add(bookInfo8);
		
		BookInfo bookInfo9=new BookInfo();
		bookInfo9.setId("BOK16");
		bookInfo9.setName("Ch11-測驗一");
		bookInfo9.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK16");
		reusltList.add(bookInfo9);
		
		BookInfo bookInfo10=new BookInfo();
		bookInfo10.setId("BOK17");
		bookInfo10.setName("Ch11-測驗二");
		bookInfo10.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK17");
		reusltList.add(bookInfo10);
		
		BookInfo bookInfo18=new BookInfo();
		bookInfo18.setId("BOK18");
		bookInfo18.setName("CH12-進階物件導向程式設計");
		bookInfo18.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK18");
		reusltList.add(bookInfo18);
		
		BookInfo bookInfo19=new BookInfo();
		bookInfo19.setId("BOK19");
		bookInfo19.setName("CH12-測驗");
		bookInfo19.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK19");
		reusltList.add(bookInfo19);
		
		BookInfo bookInfo20=new BookInfo();
		bookInfo20.setId("BOK20");
		bookInfo20.setName("Ch7-Java 集合架構與泛型");
		bookInfo20.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK20");
		...
		bookInfo21.setUrl("http://120.125.83.32:8080/readium-js-viewer/dev/index_RequireJS_no-optimize.html?epub=..%2Fepub_content%2FBOK08&bookNo=BOK21");
